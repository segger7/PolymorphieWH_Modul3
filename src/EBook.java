...
public class EBook extends Medium{
    ...
    public EBook(String titel, Genre genre, Urheber urheber, LocalDate erscheinungsdatum, String autor, String ISBN, int seitenzahl, String auflage, String kommentar) {
